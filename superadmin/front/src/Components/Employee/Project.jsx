...
import RowProject from './Mapping/RowProject'
...
export default function Project() {
    ...
    return (
        <div className="container">
            ...
            {reportsData.map( value =>{return <RowProject key={value.projectID} project={value}/>})}
            </div></div> : <h3> You have no reports yet... </h3>}
        </div>    
    )
}